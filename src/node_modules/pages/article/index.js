...
const Article = props => {
    ...
    const [{response: fetchArticleResponse, fetchArticleError, fetchArticleIsLoading}, doFetch] = useFetch(apiUrl)
                            ...
                            {isAuthor() && (
                                <span>
                                    ...
                                    <button
                                        ...
                                        className="btn btn-outline-danger btn-sm">Delete Article</button>
                                </span>
                            )}
                        </div>
                    </div>
